...
import { DemoDisclaimerComponent } from '../../shared/ui/demo-disclaimer/demo-disclaimer.component';

@Component({
  selector: 'app-vaulton-nav',
  standalone: true,
  imports: [CommonModule, RouterModule, DemoDisclaimerComponent],
  template: `
    <div
      class="z-50 w-full transition-all duration-700 bg-transparent border-none top-0"
      [class.absolute]="isAuthPage()"
      [class.sticky]="!isAuthPage()"
    >
      <nav class="w-full px-4 md:px-8 h-20 md:h-24 flex items-center justify-between">
        ...
        <div *ngIf="isVaultPage()" class="vault-actions-container">
          <div 
