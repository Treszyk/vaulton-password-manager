...
@Component({
  ...
  template: `
    <nav
      class="z-50 w-full flex flex-col transition-all duration-700 bg-transparent border-none"
      [class.absolute]="isAuthPage()"
      [class.sticky]="!isAuthPage()"
      [class.top-0]="true"
    >
      <div class="w-full px-4 md:px-8 h-20 md:h-24 flex items-center justify-between">
