...
@Component({
  ...
  template: `
    ...
    >
      ...
      >
        <div
          class="w-full md:max-w-lg bg-transparent md:bg-vault-black border-none md:border border-zinc-600 rounded-t-[2rem] md:rounded-3xl shadow-none md:shadow-2xl overflow-hidden flex flex-col max-h-[85vh] relative pointer-events-auto"
